...
public class MarioView extends SurfaceView implements SurfaceHolder.Callback  {
	...
	public void surfaceCreated(SurfaceHolder holder) {
		...
		mt1 = new MarioThread(this.getHolder(), board);
		mt2 = new MarioThread(this.getHolder(), board);
		mt1.start();
	...
	public void surfaceDestroyed(SurfaceHolder holder) {
		...
		try {
			...
			System.out.println("Mario Thread1 is alvie: "+mt1.isAlive());
			mt2.join();
			System.out.println("Mario Thread2 Terminated!");
			System.out.println("Mario Thread2 is alvie: "+mt2.isAlive());
